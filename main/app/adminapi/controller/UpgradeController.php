    ...
    public function upData()
    {
        ...
        $data['update_sql'] = [
            [
                ...
                'sql' => "ALTER TABLE `@table` ADD `num` DECIMAL(10,2) NOT NULL DEFAULT '0.00' COMMENT '权益值、余额、svip天数、红包' AFTER `type`"
            ],[
                'code' => 560,
                'type' => 3,
                'table' => "luck_lottery_record",
                ...
                'type' => -1,
                'table' => "luck_prize",
                'sql' => "ALTER TABLE `@table` CHANGE `num` `num` DECIMAL(10,2) NOT NULL DEFAULT '0.00' COMMENT '权益值 经验 会员天数';"
            ],[
                'code' => 560,
                'type' => -1,
                'table' => "page_categroy",
...
(15, 3, 'integral', '权益值商品', 75, 1, 1626831994),
(16, 4, 'news', '文章', 100, 1, 1626831994),
(17, 5, 'lottery_list', '权益值抽奖', 100, 1, 1626831994),
...
(24, 8, 'link', '权益值链接', 85, 1, 1626831994),
...
(12, 20, 1, '我的权益值', '/pages/users/user_integral/index', '', '', 1, 0, 1735113378),
...
(25, 24, 1, '权益值商城', '/pages/points_mall/index', '', '', 1, 0, 1735114739),
(26, 24, 1, '权益值商品', '/pages/points_mall/integral_goods_list', '', '', 1, 0, 1735114753),
(27, 24, 1, '权益值兑换记录', '/pages/points_mall/exchange_record', '', '', 1, 0, 1735114771),
...
(34, 27, '', '权益值管理', 'admin', 'marketing.user_point', '', '', '', '[]', 95, 1, 1, 1, '/marketing/user_point', '27', 1, 'marketing', 0, 'marketing-user_point-index', 0, '权益值管理'),
...
(79, 34, '', '权益值配置', 'admin', 'setting.system_config/index.html', 'index', '', '', '[]', 0, 1, 1, 1, '/marketing/integral/system_config/2/11', '27/34', 1, 'marketing', 1, 'marketing-integral-system_config', 0, '权益值配置'),
...
(905, 34, '', '权益值商品', 'admin', '', '', '', '', '[]', 95, 1, 1, 1, '/marketing/store_integral/index', '27/34', 1, '', 0, 'marketing-store_integral', 0, '权益值商品'),
(909, 27, '', '抽奖管理', 'admin', '', '', '', '', '[]', 90, 1, 1, 1, '/marketing/lottery/index', '27', 1, '', 0, 'marketing-lottery-index', 0, '抽奖管理'),
(912, 34, '', '权益值订单', 'admin', '', '', '', '', '[]', 90, 1, 1, 1, '/marketing/store_integral/order_list', '27/34', 1, '', 0, 'marketing-store_integral-order', 0, '权益值订单'),
...
(1001, 34, '', '权益值记录', 'admin', '', '', '', '', '[]', 85, 1, 1, 1, '/marketing/point_record', '27/34', 1, '', 0, 'marketing-point_record-index', 0, '权益值记录'),
(1002, 34, '', '权益值统计', 'admin', '', '', '', '', '[]', 100, 1, 1, 1, '/marketing/point_statistic', '27/34', 1, '', 0, 'marketing-point_statistic-index', 0, '权益值统计'),
...
(2457, 34, '', '权益值商品添加', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/marketing/store_integral/create', '27/34', 3, '', 0, 'marketing-store_integral-create', 0, '权益值商品添加'),
...
(2501, 10, '', '权益值余额', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '9/10', 3, '', 0, 'user-set-balance', 0, '权益值余额'),
(2502, 2501, '', '修改权益值余额表单', '', '', '', 'user/edit_other/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'user-edit_other', 0, '修改权益值余额表单'),
(2503, 2501, '', '修改权益值余额', '', '', '', 'user/update_other/<id>', 'PUT', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'user-update_other', 0, '修改权益值余额'),
...
(2713, 905, '', '添加权益值商品', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '27/34/905', 3, '', 0, 'point-product-add', 0, '添加权益值商品'),
(2714, 905, '', '编辑权益值商品', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '27/34/905', 3, '', 0, 'point-product-edit', 0, '编辑权益值商品'),
(2715, 905, '', '删除权益值商品', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '27/34/905', 3, '', 0, 'point-product-delete', 0, '删除权益值商品'),
(2716, 905, '', '权益值商品状态', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '27/34/905', 3, '', 0, 'point-product-status', 0, '权益值商品状态'),
(2717, 905, '', '兑换记录', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '27/34/905', 3, '', 0, 'point-product-record', 0, '兑换记录'),
(2718, 2713, '', '权益值商品新增或编辑', '', '', '', 'marketing/integral/<id>', 'POST', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral', 0, '权益值商品新增或编辑'),
(2719, 2714, '', '权益值商品新增或编辑', '', '', '', 'marketing/integral/<id>', 'POST', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-6465e598dac7e', 0, '权益值商品新增或编辑'),
(2720, 2714, '', '权益值商品详情', '', '', '', 'marketing/integral/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-6465e598dac85', 0, '权益值商品详情'),
(2721, 2715, '', '权益值商品删除', '', '', '', 'marketing/integral/<id>', 'DELETE', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-6465e5a7d7e0b', 0, '权益值商品删除'),
(2722, 2716, '', '修改权益值商品状态', '', '', '', 'marketing/integral/set_show/<id>/<is_show>', 'PUT', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-set_show', 0, '修改权益值商品状态'),
...
(2729, 2723, '', '权益值订单发送货', '', '', '', 'marketing/integral/order/delivery/<id>', 'PUT', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-delivery', 0, '权益值订单发送货'),
(2730, 2723, '', '获取权益值订单配送信息表单', '', '', '', 'marketing/integral/order/distribution/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-distribution', 0, '获取权益值订单配送信息表单'),
(2731, 2723, '', '修改权益值订单配送信息', '', '', '', 'marketing/integral/order/distribution/<id>', 'PUT', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-distribution', 0, '修改权益值订单配送信息'),
(2732, 2723, '', '权益值订单获取物流公司', '', '', '', 'marketing/integral/order/express_list', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-express_list', 0, '权益值订单获取物流公司'),
(2733, 2723, '', '权益值订单快递公司电子面单模版', '', '', '', 'marketing/integral/order/express/temp', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-express-temp', 0, '权益值订单快递公司电子面单模版'),
(2734, 2723, '', '权益值订单列表获取配送员', '', '', '', 'marketing/integral/order/delivery/list', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-delivery-list', 0, '权益值订单列表获取配送员'),
(2735, 2723, '', '权益值订单获取面单默认配置信息', '', '', '', 'marketing/integral/order/sheet_info', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-sheet_info', 0, '权益值订单获取面单默认配置信息'),
(2736, 2723, '', '权益值订单获取物流信息', '', '', '', 'marketing/integral/order/express/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-express', 0, '权益值订单获取物流信息'),
(2737, 2724, '', '权益值商城订单详情数据', '', '', '', 'marketing/integral/order/info/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-info', 0, '权益值商城订单详情数据'),
(2738, 2725, '', '获取权益值订单状态', '', '', '', 'marketing/integral/order/status/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-status', 0, '获取权益值订单状态'),
(2739, 2726, '', '打印权益值订单', '', '', '', 'marketing/integral/order/print/<id>', 'GET', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-print', 0, '打印权益值订单'),
(2740, 2727, '', '权益值记录列表备注', '', '', '', 'marketing/point_record/remark/<id>', 'POST', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-point_record-remark', 0, '权益值记录列表备注'),
(2741, 2728, '', '权益值订单确认收货', '', '', '', 'marketing/integral/order/take/<id>', 'PUT', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-integral-order-take', 0, '权益值订单确认收货'),
(2742, 1001, '', '权益值记录备注', 'admin', '', '', '', '', '[]', 0, 1, 1, 1, '/', '27/34/1001', 3, '', 0, 'point-record', 0, '权益值记录备注'),
(2743, 2742, '', '权益值记录列表备注', '', '', '', 'marketing/point_record/remark/<id>', 'POST', '[]', 1, 1, 1, 1, '', '', 2, '', 0, 'marketing-point_record-remark-6465fd1a75f76', 0, '权益值记录列表备注'),
